...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public static final String COLUMN_ADDRESS = "sqlite";
    private String name;
    ...
    public void onCreate(SQLiteDatabase db) {
        final String SQL_CERATE_MOVIE_TABLE ="CREATE TABLE" + TABLE_SQLite + " (" +
                COLUMN_ID + " INTEGER PRIMARY KEY autoincrement, " +
                COLUMN_NAME + " TEXT NOT NULL, " +
                COLUMN_ADDRESS + "TEXT NON NULL" +
                " )";
        db.execSQL(SQL_CERATE_MOVIE_TABLE);
    }
    ...
    public void update(int id, String trim, String address) {
        SQLiteDatabase database = this.getWritableDatabase();
